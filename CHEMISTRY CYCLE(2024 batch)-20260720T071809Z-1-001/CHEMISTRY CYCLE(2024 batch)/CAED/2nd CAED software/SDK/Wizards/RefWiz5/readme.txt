...
manufacturing projects using MicroSoft VC++ 5.0.

In order for the wizard to appear as a choice in your VC++ "new project" dialog, you must copy the .awx and .hlp files
to your msdev\SharedIde\template directory. Once copied, simply run msdev and invoke the "new file" command from the IDE. From
