Program Name : ANSITABLE (ANSITABLE.DLL)
...
---------
	...
	o Open a file in SE-Sheet Metal
	  ...
	  - In the field key-in: ANSITABLE.PZL
...
- An error occurs for some reason when the PZL function is called for some edits to Sheet Metal features.
  The error occurs the first time a division operation is performed in the VB dll. Solid Edge it trying
