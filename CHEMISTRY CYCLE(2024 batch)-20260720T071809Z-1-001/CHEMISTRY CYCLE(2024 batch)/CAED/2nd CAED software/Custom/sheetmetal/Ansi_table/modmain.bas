...
Option Explicit
Global Const InToMeter = 0.0254
Global Const PI = 3.14159265359
Global Const gTol = 0.0002 'Tolerance used to determine if there is a match in the table. (Inches)
...
Public Function ItoM(InchValue As Double) As Double
 ItoM = InchValue * InToMeter
End Function

'Returns a number converted from meters to inches
Public Function MtoI(MeterValue As Double) As Double
